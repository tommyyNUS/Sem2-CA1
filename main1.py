...
#Fittinh multiple linear regression model to dataset
...
rdm_reg = RandomForestRegressor(n_estimators = 300, random_state = 0)
...
print("Accuracy score: "+str(accuracy_score(y_test, y_pred_dtree, normalize=True)))
...
#plt.plot(X_test['accommodates'], lin_reg_2.predict(poly_reg.fit_transform(X_test)), color = 'blue')
